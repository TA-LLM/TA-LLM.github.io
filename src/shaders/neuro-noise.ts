/**
 * "Neuro Noise" fragment shader, adapted from Paper Shaders
 * (https://shaders.paper.design/neuro-noise), Apache-2.0
 * (https://github.com/paper-design/shaders), through the 21st.dev Shader
 * Builder; saved from research/moodboard/_taste/shader/shader_prompt.txt
 * unchanged. Only the uniforms are ours (scripts in src/scripts/shader-band.ts),
 * so its filaments run in the site's amber over ink instead of orange.
 */
